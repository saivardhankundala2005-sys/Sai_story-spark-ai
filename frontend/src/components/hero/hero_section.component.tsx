    ...
    <div className="relative min-h-screen bg-white text-slate-900 dark:bg-slate-900 dark:text-slate-100 overflow-hidden font-sans transition-colors duration-300">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-32">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="motion-card bg-white/85 dark:bg-slate-800/40 backdrop-blur-xl border border-slate-200 dark:border-slate-700/50 hover:border-blue-400/30 rounded-3xl p-8 shadow-xl group cursor-pointer transition-all duration-300">
            ...
            <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200 mb-3 transition-colors duration-300">Infinite Variations</h3>
          ...
          <div className="motion-card bg-white/85 dark:bg-slate-800/40 backdrop-blur-xl border border-slate-200 dark:border-slate-700/50 hover:border-indigo-400/30 rounded-3xl p-8 shadow-xl group cursor-pointer transition-all duration-300">
            ...
            <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200 mb-3 transition-colors duration-300">AI Co-Writer</h3>
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed transition-colors duration-300">
              Stuck on a paragraph? Let our advanced AI models suggest the next perfect sentence to keep your momentum going.
            </p>
          </div>

          <div className="motion-card bg-white/85 dark:bg-slate-800/40 backdrop-blur-xl border border-slate-200 dark:border-slate-700/50 hover:border-purple-400/30 rounded-3xl p-8 shadow-xl group cursor-pointer transition-all duration-300">
            ...
            <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200 mb-3 transition-colors duration-300">Community Driven</h3>
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed transition-colors duration-300">
